...
function OtpVerification() {
    ...
    const handleOnResendOtp = async (e) => {
        try {
            await axios.post('http://localhost:4000/user/resend-otp', { email }); 
    ...
    return (
        <div className="max-w-md mx-auto my-10 bg-pink-100 p-5">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center">
                ...
                <span className='block text-pink-600 text-sm text-right font-bold mb-3 hover:text-pink-800 cursor-pointer' onClick={handleOnResendOtp}>Resend OTP</span>
